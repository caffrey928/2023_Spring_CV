...
def benchmark(dataset_path: str, subjects: list, model_path: str):
...
if __name__ == '__main__':
    ...
    if(len(sys.argv) == 3):
        ...
        benchmark(dataset_path, subjects, model_path)
    else:
        print("Usage: python3 eval.py [dataset_path] [model_path]")
